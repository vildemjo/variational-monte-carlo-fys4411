...
/* The standard set-up */
    ...
    double stepLength       = 0.7;          // Metropolis step length.
    ...
    // system->setFileName                   ("Output/initial_test/obd_i_not_random");
    ...
    for (int i = 0; i < I.size(); i++ ){
        ...
        string filename = "initial_test/" + 
                methodName + "few_MC_energy_alpha.txt";
